export const enums = {
  ...
  CONTENT: {
    ...
    KLASS_URL_EMPTY: 'Feltet kan ikke være blankt',
    KLASS_INVALID: {
      CODES: 'Klass url-en er ikke gyldig, den mangler minst en kode',
      DESCRIPTION: 'Klass url beskrivelsen er ikke gyldig'
    },
  ...
  PROPERTY: {
    ...
    VALUES: 'values',
    VERSION: 'version',
    VERSION_RATIONALE: 'versionRationale',
    VERSION_VALID_FROM: 'versionValidFrom'
  },
  REFERENCE: {
    MULTILINGUAL_TEXT: '#/definitions/MultilingualText'
  },
  STATE: {
    ERRORS: 'errors',
    FORM: 'form',
  ...
  TYPE: {
    ...
    BOOLEAN: 'boolean',
    DATE: 'date-time',
    DROPDOWN_MULTIPLE: 'dropdownMultiple',
