...
class BarChart extends Component {
  ...
  prepareData (index) {
    ...
    let allowedLabels = Object.keys(data[index]).filter((e) => !disallowed.includes(e))
  ...
  render () {
    ...
    return (
      <Fragment>
        ...
        <datalist id='years'>
          {years && years.map(e => <option key={e} value={e} />)}
        </datalist>
        ...
        <datalist id='municipalities'>
          {municipalities && municipalities.map(e => <option key={e} value={e} />)}
        </datalist>
        <Bar
